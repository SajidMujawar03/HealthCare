...
<div className="max-w-[570px] mt-[30px] mx-auto bg-[#0066ff2c] rounded-md flex items-center justify-between">
  ...
  <input type="search" className='py-4 pl-4 pr-4 bg-transparent w-full focus:outline-none cursor-pointer placeholder:text-slate-600 ' placeholder='Search A Doctor'/>
  <button className='btn mt-0 rounded-[0] rounded-r-md '>Search</button>
    ...
    <section>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 lg:gap-[5px] mt-[30px] lg:mt-[55px] ">
        {doctors.map((doctor)=>(
